 ...
 * 支持onLongItemClick
 */
public abstract class NewBaseAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public NewBaseAdapter(Context mContext, List<T> mDatas, int mLayoutId) {
    ...
    protected abstract void convert(Context mContext, BaseViewHolder holder, T t, int postion);
