...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder setCheckBox(int viewId, String value, String checkValue) {
    ...
    public BaseViewHolder setCheckBox(int viewId, String value, String checkValue, String uncheckStr, String checkStr) {
        CheckBox checkBox = getView(viewId);
        if (value.equals(checkValue)) {
            checkBox.setChecked(true);
            checkBox.setText(checkStr);
        } else {
            checkBox.setChecked(false);
            checkBox.setText(uncheckStr);
        }
        return this;
    }
