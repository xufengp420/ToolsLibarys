package com.example.xufeng.toolslibary.views.switchbtn;
...
public class Configuration implements Cloneable {
	...
	static class Default {
		static int DEFAULT_OFF_COLOR = Color.parseColor("#F0F0F2");
		static int DEFAULT_ON_COLOR = Color.parseColor("#2CC786");
